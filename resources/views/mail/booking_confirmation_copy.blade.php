            ...
            <tr>
                <td class="content">
                    ...
                    <p>Se hai bisogno di cancellare la tua prenotazione, puoi utilizzare il seguente link: <a
                            ...
                            prenotazione</a></p>
                    <p> Per confermare la tua prenotazione, puoi utilizzare il seguente link: <a
                            href="http://localhost/conferma-prenotazione?token={{ $booking->get('qr_token') }}">Conferma
                            prenotazione</a></p>
                    <div class="footer">
                        <p class="signature">Un caloroso saluto,</p>
                        <p class="brand">Il Team di PHPrenotation System</p>
                    </div>
                </td>
            </tr>
        </table>
